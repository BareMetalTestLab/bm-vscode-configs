...
eval $SSH_CMD $REMOTE_DEBUG_HOST "nohup ./JLinkRemoteServer -select usb=$JLINK_SERIAL -device $JLINK_DEVICE -endian little -speed 4000 -if swd -vd &> /tmp/remote/JLinkRemoteServer.log &"
